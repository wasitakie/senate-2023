...
session_start();
//5//
$page8_array = array("", $_POST["q38"], $_POST["q39"], $_POST["q40"], $_POST["q41"], $_POST["cv8"]);

$sumData = array('', '0', '25', '50', '75', '100');

$sumDataAll = ($sumData[$_POST["q38"]] + $sumData[$_POST["q39"]] + $sumData[$_POST["q40"]] + $sumData[$_POST["q41"]]) / 4;
