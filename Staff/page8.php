    ...
    <div class="container manu">
        <div class="col-md-12">
            ...
            <form action="page8Insert.php" method="post" class="btnsub">
                <div class="box">
                    <div class="question">
                        <label for="formGroupExampleInput" class="form-label"><span class="textQ">38. ท่านรู้สึกว่า
                ...
                <div class="box">
                    <div class="question">
                        <label for="formGroupExampleInput" class="form-label"><span class="textQ">39. ท่านผ่อนชำระหนี้
