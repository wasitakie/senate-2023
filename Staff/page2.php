    ...
    <div class="container manu">
        <div class="col-md-12">
            ...
            <form action="page2Insert.php" method="post" class="btnsub">
                <div class="box">
                    <div class="question">
                        <label for="formGroupExampleInput" class="form-label"><span class="textQ"> 11.
                ...
                <div class="box">
                    <div class="question">
                        <label for="formGroupExampleInput" class="form-label"><span class="textQ"> 12. โดยรวมแล้วใน 1
