    ...
    <div class="container manu">
        <div class="col-md-12">
            ...
            <form action="page10Insert.php" method="post" class="btnsub">
                ...
                <div class="box">
                    <div class="question">
                        <label for="formGroupExampleInput" class="form-label"><span class="textQ">66. ท่านเป็นคน คิดใหม่
                ...
                <div class="box">
                    <div class="question">
                        <label for="formGroupExampleInput" class="form-label"><span class="textQ">67. ในแต่ละวัน
