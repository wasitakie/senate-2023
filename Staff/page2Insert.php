...
$page2_array = array("", $_POST["q11"], $_POST["q12"], $_POST["q13"], $_POST["q14"], $_POST["q15"], $_POST["cv2"]);

$sumData = array('', '0', '25', '50', '75', '100');

$sumDataAll = ($sumData[$_POST["q11"]] + $sumData[$_POST["q12"]] + $sumData[$_POST["q13"]] + $sumData[$_POST["q14"]] + $sumData[$_POST["q15"]]) / 5;
