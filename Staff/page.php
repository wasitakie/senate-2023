                        ...
                        <div class="row g-3">
                            <div class="col">
                                <label type="text" for="formGroupExampleInput" class="form-label"><span class="textQ">
                                        1.1 ชื่อ-นามสกุล</span></label>

                                <div class="form-check">
                                    <label type="text" for="formGroupExampleInput" class="form-label"><?= $_SESSION["name"] ?> </label>
                ...
                <div class="box">
                    <div class="question">
                        <div class="row g-3">
                            <div class="col">
                                <label type="text" for="formGroupExampleInput" class="form-label"><span class="textQ">
                                        1.2 ตำแหน่ง</span></label>

                                <div class="form-check">
                                    <label type="text" for="formGroupExampleInput" class="form-label"><?= $_SESSION["position"] ?> </label>
