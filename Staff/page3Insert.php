...
session_start();
//6//
$page3_array = array("", $_POST["q16"], $_POST["q17"], $_POST["q18"], $_POST["q19"], $_POST["q20"], $_POST["cv3"]);

$sumData = array('', '0', '25', '50', '75', '100');

$sumDataAll = ($sumData[$_POST["q16"]] + $sumData[$_POST["q17"]] + $sumData[$_POST["q18"]] + $sumData[$_POST["q19"]] + $sumData[$_POST["q20"]]) / 5;
