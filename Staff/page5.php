    ...
    <div class="container manu">
        <div class="col-md-12">
            ...
            <form action="page5Insert.php" method="post" class="btnsub">
                ...
                <div class="box">
                    <div class="question">
                        <label for="formGroupExampleInput" class="form-label"><span class="textQ"> 27. ท่าน ทำกิจกรรม
                ...
                <div class="box">
                    <div class="question">
                        <label for="formGroupExampleInput" class="form-label"><span class="textQ">28.
