$(".btnsub").submit(function () {
  if ($(".q16:checked").length == "") {
    alert("16. โดยรวมแล้วท่านรู้สึกเอื้ออาทร/ ห่วงใยต่อคนรอบข้างหรือไม่");
    $("#checkq16-1").focus();
    return false;
  }

  if ($(".q17:checked").length == "") {
    alert("17. โดยรวมแล้วท่านให้การช่วยเหลือแก่คนรอบข้างหรือไม่");
    $("#checkq17-1").focus();
    return false;
  }
  ...
  if ($(".q19:checked").length == "") {
    alert("19.โดยรวมแล้วท่านเข้าร่วมกิจกรรมที่เป็นประโยชน์ต่อสังคม");
    $("#checkq19-1").focus();
    return false;
  }
  if ($(".q20:checked").length == "") {
    alert("20.โดยรวมแล้วท่านได้ทำกิจกรรมที่สามารถทำได้ด้วยตนเองและ");
    $("#checkq20-1").focus();
    return false;
  }
